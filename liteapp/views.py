...
def home(request):
	...
	desc=_('''
	Hi, I'm Debasis Nath, I am a Python-Django,  Ionic-Angular, Core PHP, Symfony Developer and AWS consultant.
    I have been working working as a Web developer with 3 years of experience in Django, Core Php, Symfony 2.8, Mysql, PostgreSQL, Firebase, Javascript jQuery. Have 4 years of experience in technical teaching. I am very much interested in Python Django development.
    I have done some projects in Django the linkes are updated in mt profile link. Also, I have a good understanding of AWS, Heroku, GIT, Docker. 
